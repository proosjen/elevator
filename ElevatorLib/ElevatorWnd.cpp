...
/**
* Constructor for elevator simulator
*
...
/** The elevator width. Based on the width of the background image
* \return Width */
...
/** The elevator height. Based on the height of the background image
* \return Height */
...
/**
* Reset a stopwatch available to a user program.
*/
...
/**
* Press the Open button on the panel in the car
*
...
/** Press the Close button on the panel in the car
*
* This function is called when the button is pressed.
* It can be used to simulate a press of the button as well.
*/
...
/** Press a floor button in the elevator panel
*
* This function is called when the button is pressed.
* It can be used to simulate a press of the button as well.
...
/** Press a call up button on a floor
*
* This function is called when the button is pressed.
* It can be used to simulate a press of the button as well.
...
/** Press a call down button on a floor
*
* This function is called when the button is pressed.
* It can be used to simulate a press of the button as well.
* \param floor The floor the button is on, starting at 1
...
/**
* Set the state of a floor light in the elevator panel
...
/**
* Get the state of a floor light in the elevator panel
* \param floor Floor to test, starting at 1
...
/** Get the state of a call light for a floor
* \param floor Floor to test, starting at 1
* \param d Direction selection (which light)
* \returns true if light is on */
...
/**
* Set the status of a door indicator light
* \param floor Floor to test, starting at 1
* \param d Direction selection (which light)
* \param s true for light on
*/
...
/** Get the state of a door indicator light
* \param floor Floor to test, starting at 1
* \param d Direction selection (which light)
* \returns true if light is on */
...
/**
* Change the elevator car loading
*/
